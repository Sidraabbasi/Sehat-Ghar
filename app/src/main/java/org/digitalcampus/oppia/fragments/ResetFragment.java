...
public class ResetFragment extends AppFragment implements SubmitListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		siginInClick = (TextView) v.findViewById(R.id.signIn);
		return v;
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		siginInClick.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                WelcomeActivity wa = (WelcomeActivity) ResetFragment.super.getActivity();
