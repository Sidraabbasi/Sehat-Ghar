...
import org.digitalcampus.oppia.activity.LandingActivity;
...
public class LoginFragment extends AppFragment implements SubmitListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		loginBtn  = (ImageButton) v.findViewById(R.id.login_btn);
	...
	public void submitComplete(Payload response) {
		...
		if(response.isResult()){
	    	...
	    	startActivity(new Intent(super.getActivity(), OppiaMainActivity.class));
